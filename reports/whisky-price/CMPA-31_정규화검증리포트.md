...
- 입력 raw 행: **5,624**  ·  distinct raw 표기: **4,670**
- 정규화(병합) 후 정본 SKU 수: **155** (whisky-list.csv 89종 중)
- 통합 데이터셋(clean 단품) 행: **1,503**
- 오염행 제거(과거평균 ⅓~3배 밖): **64**

> ⚠️ 신뢰도: 국내(한글) 매칭은 명시적 사전(match/not) 기반 고신뢰. 해외 매칭(127행, reason=`en`)은 name_en 브랜드+년수 토큰 휴리스틱이라 보조(advisory) 신뢰도 — 리포트 본표 반영 전 스팟체크 권장. 모호(후보 2개↑)는 미매칭 처리.

## 소스별 정규화/제외 집계

| 소스 | 입력스킵 | matched | unmatched | 비위스키제외 | 비단품제외 | 가격결측 | 오염제거 |
|---|--:|--:|--:|--:|--:|--:|--:|
| youtube_martweb | 0 | 749 | 38 | 18 | 7 | 0 | 5 |
| dailyshot | 96 | 78 | 1 | 0 | 0 | 0 | 2 |
| overseas | 0 | 183 | 3,890 | 0 | 24 | 0 | 56 |
| **합계** | 96 | 1,010 | 3,929 | 18 | 31 | 0 | 63 |

## 표기변형 병합 예시 (raw 표기 ≥ 3종 → 1 SKU)

- **[w035] 라프로익 10년** ← 18종: `Laphroaig - 10y, 43%`, `Laphroaig - 10y, Cask Strength, Batch 14, 58.6%`, `Laphroaig 10 Year Old`, `Laphroaig 10 Year Old Cask Strength Batch 017`, `Laphroaig 10 Year Old Cask Strength Batch 9 Single Malt Islay Whisky`, `Laphroaig 10 Year Old Sherry Oak Finish` …
- **[w012] 맥캘란 12년 더블캐스크** ← 16종: `Macallan - Double Cask, 12y, 2018 release, 40%`, `Macallan - Double Cask, 12y, 2025 release, 40%`, `【正規 箱付】ザ マッカラン シェリーオーク 12年 700ml 40度（スコッチ シングルモルトウイスキー）`, `【正規輸入品】 ザ マッカラン シェリーオーク 12年 40% 700ml 箱付 シングルモルト スコッチ ウイスキー`, `ザ マッカラン 12年 700ml (旧ボトル)`, `ザ マッカラン 12年 シングルモルト シェリーオーク 40% 700ml 箱なし スコッチ ウイスキー` …
- **[w066] 잭다니엘 No.7** ← 15종: `잭 다니에 700ml`, `잭 다니엘스 200ml`, `잭 다니엘스 테네시 위스키 1L`, `잭다니스 1L`, `잭다니엘 No.7`, `잭다니엘 싱글배럴 잔패키지` …
- **[w018] 글렌드로낙 12년** ← 15종: `GlenDronach - 12y, Original, 43%`, `GlenDronach Original 12 Years Old Single Malt Scotch Whisky`, `グレンドロナック 12年`, `ザ グレンドロナック 12年 43% 700ml 箱付 シングルモルト スコッチ ウイスキー`, `글랜드로 12년 700ml`, `글랜드로 오드 to투더 엠버스 700ml` …
...
- **[w123] 라벨 5** ← 12종: `Glenburgie 2004 Distillery Labels by Gordon & MacPhail Single Malt Scotch Whisky`, `Ichiro's Malt & Grain Premium World Blended Whisky (Black Leaf Label)`, `Karuizawa 1990 Vintage "Geisha Label" Single Cask #679 Single Malt Japanese Whisky`, `Karuizawa Asama Paper Label Vintage 1999-2000 Japanese Single Malt Whisky`, `Mars Komagatake Heavily Peated (Mizunara Private Label) Whisky`, `Mars Single Cask Kansyou Issiki 20 Years Single Malt Japanese Whisky (No Box Stained Label)` …
- **[w067] 잭다니엘 애플** ← 12종: `잭 다니엘스 애플 1L`, `잭 다니엘스 애플 200ml`, `잭 다니엘스 애플 500mml`, `잭다니에스 애플 1L`, `잭다니엘 애플`, `잭다니엘 애플 1L` …
- **[w008] 발베니 12년 더블우드** ← 12종: `발베니 12년`, `발베니 12년 700ml`, `발베니 12년 더블 우드 700ml`, `발베니 12년 더블로드 700ml`, `발베니 12년 더블우드`, `발베니 12년 더블우드 700ml` …
- **[w050] 조니워커 블랙라벨 12년** ← 11종: `【世界五大ウイスキー】スコッチウイスキー  ジョニーウォーカー ブラックラベル12年《瓶 お得な1L×1本》`, `조니어커 블랙`, `조니워커 블랙 1.75L`, `조니워커 블랙 200ml`, `조니워커 블랙 700ml`, `조니워커 블랙라베 700ml` …
...
## 미매칭 raw 표기 (3982종) — 마스터 SKU 확장 후보
...
- `Aberfeldy 25 Year Old 2001 Hand Filled Distillery Cask 500058`
...
- `Aberlour-Glenlivet Over 8 Years Old 1965 Vintage Single Malt Scotch Whisky`
...
- … 외 3942종 (전체는 `assets/whisky-aliases.csv` status=unmatched)
