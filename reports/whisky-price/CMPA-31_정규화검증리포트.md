...
- 입력 raw 행: **5,658**  ·  distinct raw 표기: **4,664**
- 정규화(병합) 후 정본 SKU 수: **155** (whisky-list.csv 89종 중)
- 통합 데이터셋(clean 단품) 행: **1,548**
- 오염행 제거(과거평균 ⅓~3배 밖): **58**

> ⚠️ 신뢰도: 국내(한글) 매칭은 명시적 사전(match/not) 기반 고신뢰. 해외 매칭(136행, reason=`en`)은 name_en 브랜드+년수 토큰 휴리스틱이라 보조(advisory) 신뢰도 — 리포트 본표 반영 전 스팟체크 권장. 모호(후보 2개↑)는 미매칭 처리.

## 소스별 정규화/제외 집계

| 소스 | 입력스킵 | matched | unmatched | 비위스키제외 | 비단품제외 | 가격결측 | 오염제거 |
|---|--:|--:|--:|--:|--:|--:|--:|
| youtube_martweb | 0 | 789 | 38 | 18 | 7 | 0 | 5 |
| dailyshot | 93 | 74 | 1 | 0 | 0 | 0 | 2 |
| overseas | 0 | 186 | 3,884 | 0 | 25 | 0 | 50 |
| **합계** | 93 | 1,049 | 3,923 | 18 | 32 | 0 | 57 |

## 표기변형 병합 예시 (raw 표기 ≥ 3종 → 1 SKU)

- **[w012] 맥캘란 12년 더블캐스크** ← 21종: `Macallan - Double Cask, 12y, 2018 release, 40%`, `Macallan - Double Cask, 12y, 2025 release, 40%`, `Macallan 12 Year Old Double Cask`, `※カートンに痛みあり　ザ・マッカラン トリプルカスク12年 700ml | スコッチ シングルモルト`, `【正規 箱付】ザ マッカラン シェリーオーク 12年 700ml 40度（スコッチ シングルモルトウイスキー）`, `【正規輸入品】 ザ マッカラン シェリーオーク 12年 40% 700ml 箱付 シングルモルト スコッチ ウイスキー` …
- **[w066] 잭다니엘 No.7** ← 16종: `잭 다니에 700ml`, `잭 다니엘스 200ml`, `잭 다니엘스 테네시 위스키 1L`, `잭다니스 1L`, `잭다니엘 No.7`, `잭다니엘 싱글배럴 잔패키지` …
- **[w035] 라프로익 10년** ← 15종: `Laphroaig - 10y, 43%`, `Laphroaig - 10y, Cask Strength, Batch 14, 58.6%`, `Laphroaig 10 Year Old Cask Strength Batch 9 Single Malt Islay Whisky`, `Laphroaig 10 Years ABV 43% Japan Release Single Malt Scotch Whisky 750 ML`, `Laphroaig 10 Years Old Cask Strength Batch 11 Scotch Single Malt Whisky`, `Laphroaig 10 Years Old Cask Strength Batch 3 Islay Single Malt Scotch Whisky` …
...
- **[w170] 맥캘란 셰리오크 18년** ← 12종: `Macallan - Sherry Oak, 18y, 2022 release, 43%`, `Macallan - Sherry Oak, 18y, 2026 release, 43%`, `Macallan 18 Year Old Sherry Oak 2026 Release`, `ザ マッカラン 18年`, `ザ マッカラン 18年 43% 700ml 箱なし スコッチ ウイスキー`, `ザ マッカラン 18年 43% 700ml 箱なし スコッチ ウイスキー アウトレット` …
...
## 미매칭 raw 표기 (3977종) — 마스터 SKU 확장 후보
...
- `Aberlour A'Bunadh Sherry Cask Collection Edition 1`
...
- … 외 3937종 (전체는 `assets/whisky-aliases.csv` status=unmatched)
