...
- 입력 raw 행: **5,554**  ·  distinct raw 표기: **4,681**
- 정규화(병합) 후 정본 SKU 수: **155** (whisky-list.csv 89종 중)
- 통합 데이터셋(clean 단품) 행: **1,431**
- 오염행 제거(과거평균 ⅓~3배 밖): **67**
...
|---|--:|--:|--:|--:|--:|--:|--:|
| youtube_martweb | 0 | 701 | 46 | 18 | 7 | 0 | 5 |
| dailyshot | 117 | 89 | 1 | 0 | 0 | 0 | 2 |
| overseas | 0 | 186 | 3,918 | 0 | 25 | 0 | 59 |
| **합계** | 117 | 976 | 3,965 | 18 | 32 | 0 | 66 |
...
- **[w012] 맥캘란 12년 더블캐스크** ← 19종: `Macallan - Double Cask, 12y, 2018 release, 40%`, `Macallan - Double Cask, 12y, 2025 release, 40%`, `【正規輸入品】 ザ マッカラン シェリーオーク 12年 40% 700ml 箱付 シングルモルト スコッチ ウイスキー`, `ザ マッカラン 12年 700ml (旧ボトル)`, `ザ マッカラン 12年 シングルモルト シェリーオーク 40% 700ml 箱なし スコッチ ウイスキー`, `ザ マッカラン 12年 シングルモルト シェリーオーク 40% 700ml 箱なし スコッチ ウイスキー アウトレット` …
...
## 미매칭 raw 표기 (3989종) — 마스터 SKU 확장 후보
...
- … 외 3949종 (전체는 `assets/whisky-aliases.csv` status=unmatched)
