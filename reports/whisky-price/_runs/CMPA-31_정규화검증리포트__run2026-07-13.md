...
- 입력 raw 행: **5,621**  ·  distinct raw 표기: **4,676**
- 정규화(병합) 후 정본 SKU 수: **155** (whisky-list.csv 89종 중)
- 통합 데이터셋(clean 단품) 행: **1,494**
- 오염행 제거(과거평균 ⅓~3배 밖): **66**
...
|---|--:|--:|--:|--:|--:|--:|--:|
| youtube_martweb | 0 | 739 | 38 | 18 | 7 | 0 | 5 |
| dailyshot | 96 | 78 | 1 | 0 | 0 | 0 | 2 |
| overseas | 0 | 186 | 3,894 | 0 | 24 | 0 | 58 |
| **합계** | 96 | 1,003 | 3,933 | 18 | 31 | 0 | 65 |

## 표기변형 병합 예시 (raw 표기 ≥ 3종 → 1 SKU)

- **[w012] 맥캘란 12년 더블캐스크** ← 19종: `Macallan - Double Cask, 12y, 2018 release, 40%`, `Macallan - Double Cask, 12y, 2025 release, 40%`, `【正規 箱付】ザ マッカラン シェリーオーク 12年 700ml 40度（スコッチ シングルモルトウイスキー）`, `【正規輸入品】 ザ マッカラン シェリーオーク 12年 40% 700ml 箱付 シングルモルト スコッチ ウイスキー`, `ザ マッカラン 12年 700ml (旧ボトル)`, `ザ マッカラン 12年 シングルモルト シェリーオーク 40% 700ml 箱なし スコッチ ウイスキー` …
...
## 미매칭 raw 표기 (3985종) — 마스터 SKU 확장 후보
...
- … 외 3945종 (전체는 `assets/whisky-aliases.csv` status=unmatched)
