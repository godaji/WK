...
- 입력 raw 행: **3,537**  ·  distinct raw 표기: **3,149**
- 정규화(병합) 후 정본 SKU 수: **88** (whisky-list.csv 89종 중)
- 통합 데이터셋(clean 단품) 행: **655**
- 오염행 제거(과거평균 ⅓~3배 밖): **38**

> ⚠️ 신뢰도: 국내(한글) 매칭은 명시적 사전(match/not) 기반 고신뢰. 해외 매칭(31행, reason=`en`)은 name_en 브랜드+년수 토큰 휴리스틱이라 보조(advisory) 신뢰도 — 리포트 본표 반영 전 스팟체크 권장. 모호(후보 2개↑)는 미매칭 처리.
...
| overseas | 0 | 53 | 2,618 | 0 | 16 | 0 | 22 |
| **합계** | 130 | 693 | 2,729 | 17 | 41 | 57 | 38 |
...
- **[w035] 라프로익 10년** ← 16종: `Laphroaig - 10y, 43%`, `Laphroaig - 10y, Cask Strength, Batch 14, 58.6%`, `Laphroaig 10 Year Old`, `Laphroaig 10 Year Old Cask Strength Batch 017`, `Laphroaig 10 Year Old Cask Strength Batch 9 Single Malt Islay Whisky`, `Laphroaig 10 Year Old Sherry Oak Finish` …
...
- **[w050] 조니워커 블랙라벨 12년** ← 11종: `Johnnie Walker 12 Years Old Black Label Blended Scotch Whisky 700ml`, `조니워커 블랙`, `조니워커 블랙 1.75L`, `조니워커 블랙 200ml`, `조니워커 블랙 700ml`, `조니워커 블랙 오징어 게임 에디션 750mml` …
- **[w023] 달모어 12년** ← 11종: `Dalmore - 12y, 40%`, `Dalmore - 12y, 40% Sherry`, `Dalmore 12 Years Old Sherry Cask Select Scotch Single Malt Whisky`, `달모어 12년`, `달모어 12년 700ml`, `달모어 12년 쉐리캐스크 700ml` …
...
- **[w042] 조니워커 그린라벨 15년** ← 9종: `Johnnie Walker Gold Label 15 Years Old 1990's Release Scotch Whisky`, `조니워커 그린`, `조니워커 그린 15년`, `조니워커 그린 700ml`, `조니워커 그린납`, `조니워커 그린납L` …
- **[w083] 산토리 가쿠빈** ← 8종: `가쿠빈`, `가쿠빈 700ml`, `가쿠빈 700ml 두 개입 메가잔 패키지`, `산토리 가쿠빈`, `산토리 가쿠빈 NAS 1920ml`, `산토리 가쿠빈 NAS 700ml` …
- **[w061] 제임슨** ← 8종: `제임스 나이시 위스키 700ml`, `제임슨`, `제임슨 700ml`, `제임슨 스탠다드`, `제임슨 스탠더드`, `제임슨 스탠더드 700ml` …
- **[w024] 달모어 2005 빈티지** ← 7종: `달모어 2 5 빈티지`, `달모어 2 5 빈티지 700ml 67만`, `달모어 2 호 빈티지 700ml 67만`, `달모어 2005 빈티지`, `달모어 2005 빈티지 67만`, `달모어 2005 빈티지 700ml 67만` …

## 미매칭 raw 표기 (2725종) — 마스터 SKU 확장 후보
...
- `Adelphi Selection - Aultmore 18y, 2000, 55% , 480b`
- … 외 2685종 (전체는 `assets/whisky-aliases.csv` status=unmatched)
