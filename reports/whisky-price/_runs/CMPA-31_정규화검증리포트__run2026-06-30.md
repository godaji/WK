...
- 입력 raw 행: **5,589**  ·  distinct raw 표기: **4,696**
- 정규화(병합) 후 정본 SKU 수: **157** (whisky-list.csv 89종 중)
- 통합 데이터셋(clean 단품) 행: **1,461**
- 오염행 제거(과거평균 ⅓~3배 밖): **68**
...
|---|--:|--:|--:|--:|--:|--:|--:|
| youtube_martweb | 0 | 730 | 37 | 18 | 7 | 0 | 5 |
| dailyshot | 117 | 89 | 1 | 0 | 0 | 0 | 2 |
| overseas | 0 | 188 | 3,931 | 0 | 25 | 0 | 60 |
| **합계** | 117 | 1,007 | 3,969 | 18 | 32 | 0 | 67 |
...
## 미매칭 raw 표기 (3999종) — 마스터 SKU 확장 후보
...
- … 외 3959종 (전체는 `assets/whisky-aliases.csv` status=unmatched)
