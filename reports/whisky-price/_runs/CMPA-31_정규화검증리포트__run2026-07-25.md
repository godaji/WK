...
- 입력 raw 행: **5,620**  ·  distinct raw 표기: **4,667**
- 정규화(병합) 후 정본 SKU 수: **155** (whisky-list.csv 89종 중)
- 통합 데이터셋(clean 단품) 행: **1,499**
- 오염행 제거(과거평균 ⅓~3배 밖): **64**
...
- **[w001] 글렌리벳 12년** ← 10종: `Glenlivet 12 Year Old Double Oak`, `Glenlivet 12 Year Old Hand Filled Batch 02`, `【正規輸入品】 ザ グレンリベット 12年 40% 1000ml 箱付 シングルモルト スコッチ ウイスキー`, `【正規輸入品】ザ グレンリベット 12年 40% 700ml 箱付 スコッチ ウイスキー`, `ザ グレンリベット 12年 1000ml`, `ザ グレンリベット 12年 200周年記念限定ボトル` …
