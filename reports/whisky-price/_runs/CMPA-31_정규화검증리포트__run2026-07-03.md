...
- 입력 raw 행: **5,609**  ·  distinct raw 표기: **4,688**
- 정규화(병합) 후 정본 SKU 수: **155** (whisky-list.csv 89종 중)
- 통합 데이터셋(clean 단품) 행: **1,464**
- 오염행 제거(과거평균 ⅓~3배 밖): **67**
...
|---|--:|--:|--:|--:|--:|--:|--:|
| youtube_martweb | 0 | 719 | 38 | 18 | 7 | 0 | 5 |
| dailyshot | 117 | 74 | 1 | 0 | 0 | 0 | 2 |
| overseas | 0 | 186 | 3,911 | 0 | 25 | 0 | 59 |
| **합계** | 117 | 979 | 3,950 | 18 | 32 | 0 | 66 |
...
- **[w170] 맥캘란 셰리오크 18년** ← 9종: `Macallan - Sherry Oak, 18y, 2022 release, 43%`, `Macallan - Sherry Oak, 18y, 2026 release, 43%`, `ザ マッカラン 18年`, `ザ マッカラン 18年 シングルモルト シェリー オーク カスク 43% 700ml 箱付 スコッチ ウイスキー`, `ザ マッカラン 18年 シングルモルト シェリー オーク カスク 43% 700ml 箱付 スコッチ ウイスキー アウトレット`, `ザ マッカラン ダブルカスク 18年` …

## 미매칭 raw 표기 (4003종) — 마스터 SKU 확장 후보
...
- … 외 3963종 (전체는 `assets/whisky-aliases.csv` status=unmatched)
