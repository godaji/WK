...
- 입력 raw 행: **5,589**  ·  distinct raw 표기: **4,625**
- 정규화(병합) 후 정본 SKU 수: **155** (whisky-list.csv 89종 중)
- 통합 데이터셋(clean 단품) 행: **1,509**
- 오염행 제거(과거평균 ⅓~3배 밖): **64**
...
|---|--:|--:|--:|--:|--:|--:|--:|
| youtube_martweb | 0 | 759 | 38 | 18 | 7 | 0 | 5 |
| dailyshot | 93 | 74 | 1 | 0 | 0 | 0 | 2 |
| overseas | 0 | 183 | 3,849 | 0 | 24 | 0 | 56 |
| **합계** | 93 | 1,016 | 3,888 | 18 | 31 | 0 | 63 |
...
- **[w012] 맥캘란 12년 더블캐스크** ← 18종: `Macallan - Double Cask, 12y, 2018 release, 40%`, `Macallan - Double Cask, 12y, 2025 release, 40%`, `Macallan 12 Year Old Double Cask`, `【正規 箱付】ザ マッカラン シェリーオーク 12年 700ml 40度（スコッチ シングルモルトウイスキー）`, `【正規輸入品】 ザ マッカラン シェリーオーク 12年 40% 700ml 箱付 シングルモルト スコッチ ウイスキー`, `ザ マッカラン 12年 700ml (旧ボトル)` …
...
## 미매칭 raw 표기 (3940종) — 마스터 SKU 확장 후보
...
- … 외 3900종 (전체는 `assets/whisky-aliases.csv` status=unmatched)
