...
- 입력 raw 행: **4,932**  ·  distinct raw 표기: **4,547**
- 정규화(병합) 후 정본 SKU 수: **88** (whisky-list.csv 89종 중)
- 통합 데이터셋(clean 단품) 행: **706**
- 오염행 제거(과거평균 ⅓~3배 밖): **45**

> ⚠️ 신뢰도: 국내(한글) 매칭은 명시적 사전(match/not) 기반 고신뢰. 해외 매칭(81행, reason=`en`)은 name_en 브랜드+년수 토큰 휴리스틱이라 보조(advisory) 신뢰도 — 리포트 본표 반영 전 스팟체크 권장. 모호(후보 2개↑)는 미매칭 처리.

## 소스별 정규화/제외 집계

| 소스 | 입력스킵 | matched | unmatched | 비위스키제외 | 비단품제외 | 가격결측 | 오염제거 |
|---|--:|--:|--:|--:|--:|--:|--:|
| youtube_martweb | 0 | 557 | 99 | 17 | 25 | 57 | 13 |
| dailyshot | 129 | 84 | 12 | 0 | 0 | 0 | 3 |
| overseas | 0 | 110 | 3,948 | 0 | 23 | 0 | 29 |
| **합계** | 129 | 751 | 4,059 | 17 | 48 | 57 | 45 |

## 표기변형 병합 예시 (raw 표기 ≥ 3종 → 1 SKU)

- **[w066] 잭다니엘 No.7** ← 19종: `잭 다니에 700ml`, `잭 다니엘스 200ml`, `잭 다니엘스 테네시 위스키 1L`, `잭다니스 1L`, `잭다니엘`, `잭다니엘 1L4` …
...
- **[w053] 조니워커 블루라벨** ← 16종: `조니 워커 블루라베`, `조니 워커 블루라베 750mml`, `조니워커 블로라 750ml`, `조니워커 블루`, `조니워커 블루 500ml`, `조니워커 블루 700ml` …
- **[w012] 맥캘란 12년 더블캐스크** ← 16종: `Macallan - Double Cask, 12y, 2018 release, 40%`, `Macallan - Double Cask, 12y, 2025 release, 40%`, `【正規輸入品】 ザ マッカラン シェリーオーク 12年 40% 700ml 箱付 シングルモルト スコッチ ウイスキー`, `ザ マッカラン 12年 700ml (旧ボトル)`, `ザ マッカラン 12年 シングルモルト シェリーオーク 40% 700ml 箱なし スコッチ ウイスキー アウトレット`, `ザ マッカラン 12年 シングルモルト シェリーオーク 40% 700ml 箱付 スコッチ ウイスキー` …
- **[w065] 짐빔 화이트** ← 14종: `진빈 법원 유스키 1L`, `진빔 1L`, `진빔 700ml`, `진빔 버유스키 1L`, `진빔 법원위스키 1L`, `진빔 법원이스키 1L` …
- **[w067] 잭다니엘 애플** ← 13종: `잭 다니엘스 애플 1L`, `잭 다니엘스 애플 200ml`, `잭 다니엘스 애플 500mml`, `잭다니에스 애플 1L`, `잭다니에스 애플 1L4`, `잭다니엘 애플` …
- **[w023] 달모어 12년** ← 13종: `Dalmore - 12y, 40%`, `Dalmore - 12y, 40% Sherry`, `Dalmore 12 Years Old Sherry Cask Select Scotch Single Malt Whisky`, `ダルモア 12年`, `ダルモア 12年 40度 700ml [ウイスキー]`, `달모어 12년` …
- **[w050] 조니워커 블랙라벨 12년** ← 12종: `Johnnie Walker 12 Years Old Black Label Blended Scotch Whisky 700ml`, `【世界五大ウイスキー】スコッチウイスキー  ジョニーウォーカー ブラックラベル12年《瓶 お得な1L×1本》`, `조니워커 블랙`, `조니워커 블랙 1.75L`, `조니워커 블랙 200ml`, `조니워커 블랙 700ml` …
- **[w001] 글렌리벳 12년** ← 12종: `Glenlivet 12 Year Old Double Oak`, `Glenlivet 12 Years Old Classic Golf Courses of Scotland 'Muirfield' Pure Single Malt Scotch Whisky`, `Glenlivet 12 Years Old Classic Golf Courses of Scotland 'Royal Dornoch' Single Malt Scotch Whisky`, `Glenlivet 12 Years Old Classic Golf Courses of Scotland 'St.Andrew' Single Malt Scotch Whisky`, `【正規輸入品】 ザ グレンリベット 12年 40% 1000ml 箱付 シングルモルト スコッチ ウイスキー`, `【正規輸入品】ザ グレンリベット 12年 40% 700ml 箱付 スコッチ ウイスキー` …
- **[w042] 조니워커 그린라벨 15년** ← 10종: `Johnnie Walker Gold Label 15 Years Old 1990's Release Scotch Whisky`, `ジョニーウォーカー グリーンラベル 15年 700ml 43%`, `조니워커 그린`, `조니워커 그린 15년`, `조니워커 그린 700ml`, `조니워커 그린납` …
- **[w084] 카발란 디스틸러리 셀렉트** ← 9종: `카발란 디스틸러 리셀레트 싱글 몰트 700ml`, `카발란 디스틸러리 셀렉트 700ml`, `카발란 디스틸러리 셀렉트 싱글`, `카발란 디스틸러리 셀렉트 싱글 700ml`, `카발란 디스틸러리 셀렉트 싱글 몰트`, `카발란 디스틸러리 셀렉트 싱글 몰트 700ml` …
- **[w008] 발베니 12년 더블우드** ← 9종: `ザ バルヴェニー 12年 ダブルウッド 40% 700ml 箱付 シングルモルト スコッチ ウイスキー`, `ザ バルヴェニー ダブルウッド 12年`, `발베니 12년`, `발베니 12년 700ml`, `발베니 12년 더블 우드 700ml`, `발베니 12년 더블로드 700ml` …

## 미매칭 raw 표기 (4065종) — 마스터 SKU 확장 후보
...
- … 외 4025종 (전체는 `assets/whisky-aliases.csv` status=unmatched)
