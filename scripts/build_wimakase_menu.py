...
PROGRAM = {
    ...
    "course": "웰컴 5잔(각 20ml) + 하이라이트 5잔(각 20ml) 테이스팅 후, 페스티벌 프리플로우(무제한) 제공",
...
TIERS = [
    {
        ...
        "name": "웰컴",
        "sub": "클래식 & 매니아픽",
        "serve": "고객이 직접 고르는 5잔(각 20ml) 제공 · 저도수 → 고도수 순 권장",
        "items": [
...
<meta name="description" content="{e(TITLE)} 위스키 바 메뉴 — 3티어 {total}종. 웰컴·하이라이트 테이스팅 200ml + 페스티벌 프리플로우. {e(VERSION)}">
<style>
{PAGE_CSS}
</style>
</head>
