...
.lgedit textarea{width:100%;background:#0f1115;border:1px solid #2a2e37;border-radius:8px;color:#e8eaed;
 font:inherit;font-size:.86rem;padding:8px;resize:vertical;min-height:52px}
